      ...
      <section id="hero" className="relative pt-48 pb-32 px-4 overflow-hidden text-center">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <p className="max-w-2xl mx-auto text-lg md:text-xl text-slate-400 mb-12 leading-relaxed font-medium">
            Étudiant en <span className="text-white">BTS SIO option SISR</span>, j'évolue actuellement en alternance en tant que Technicien Informatique chez Solarys "Groupement les Mousquetaires". Passionné par l'infrastructure réseau, la virtualisation et la cybersécurité opérationnelle.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-5">
            ...
            className="group px-8 py-5 bg-blue-500/10 hover:bg-blue-500/20 text-blue-400 font-black rounded-2xl transition-all border border-blue-500/20 flex items-center gap-3 uppercase text-xs tracking-widest inline-flex backdrop-blur-sm"
            >
